...
export function SignInScreen() {
  ...
  return (
      <div className="mx-auto w-full max-w-[560px] rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.07),rgba(255,255,255,0.03))] p-5 shadow-[0_18px_52px_rgba(0,0,0,0.24)] sm:p-6">
